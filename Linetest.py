...
from linebot.models import (
    ...
    SeparatorComponent, QuickReply, QuickReplyButton ,AudioSendMessage
)
      ...
      "styles": {
        "footer": {
          "separator": false
            ...
            line_bot_api.reply_message(event.reply_token, FlexSendMessage(alt_text='TEST',contents=message))
